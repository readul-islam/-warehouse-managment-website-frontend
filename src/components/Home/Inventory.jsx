...
//   const {inventorys} = useApi();
    return (
        ...
        <div className="max-w-sm shadow-xl py-4 rounded-lg border dark:bg-gray-800 dark:border-gray-700">
                <div>
                    <img className="  pb-3 w-full h-[300px] p-4" src={inventory.banner} alt="product imag" />
                </div>
                <div className="px-5 space-y-2">
                <div>
                    <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{inventory?.title}</h5>
                </div>
                ...
                <div className="flex justify-between items-center">
                    <span className="text-2xl font-semibold text-gray-900 dark:text-white">${inventory.price}</span>
                    <Link to={`/inventory/${inventory._id}`} className="text-white bg-sky-600 hover:bg-sky-800 duration-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Manage</Link>
                </div>
            </div>
        </div>
